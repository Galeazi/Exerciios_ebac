...
Quando preencho email com todos os outros campos obrigatorios no formato valido
Então finalizo o cadastro para concluir a compra

Cenário: Validar menssagem para formato invalido do e-mail
Quando eu preencho email no formato invalido com todos os outros campos obrigatorios no formato valido
